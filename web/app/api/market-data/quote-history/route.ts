...
import type { ElectronicChipFlowPriceHistory } from "@/lib/electronic-chip-flow-alerts";
...
export async function POST(request: Request) {
  try {
    ...
    const payload = await backendJson<{ items: ElectronicChipFlowPriceHistory[] }>(
