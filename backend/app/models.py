...
class DayTradingSettings(Base):
    ...
    latest_entry_time: Mapped[str] = mapped_column(String(5), default="11:00")
...
class SuperAIDaytradeSetting(Base):
    ...
    max_stop_distance_pct: Mapped[Decimal] = mapped_column(Numeric(7, 4), nullable=False, default=Decimal("1.0"))
